...
;-------------------------------------------------------------------------------
;PROCESS_TIME: Esta função não recebe argumentos, e reduz a TIMER_TICK 
;-------------------------------------------------------------------------------
PROCESS_TIME:   MVI     R2, TIMER_TICK
                ...
                JMP     R7
;--------------------------------------------------------------------------------           
;limpa_terreno: Esta função recebe como argumento um vetor (o terreno) e a 
;               dimensão do vetor, e devolve o vetor nulo (limpo)
;--------------------------------------------------------------------------------
...
;-------------------------------------------------------------------------------
;limpa_pontuacao: Esta função recebe uma tabela, e devolve essa tabela a zeros
;                 colocando o resultado no display
;--------------------------------------------------------------------------------
limpa_pontuacao:
                MVI     R3, 0
                STOR    M[R2], R3
...
;================================================================================
;atualizajogo: Esta função recebe um vetor como argumento, bem como a sua 
;              dimensão, e devolve todos os elementos do vector uma posição 
;              para a esquerda (isto é, do endereço n para o endereço n-1),
;              sendo que na última posição vai devolver um número gerado pela
;              função geracato.
;================================================================================
...
;================================================================================
;geracato: Esta função recebe um inteiro como argumento, e devolve 
;          um inteiro "aleatório", que pode ser zero com uma probabilidade
;          predefinida de 95%, ou um valor uniformemente 
...
;--------------------------------------------------------------------------------                
;desenha_chao: Esta função recebe a dimensão do terminal e a respetiva posição
;              como argumentos e devolve a representação gráfica do chão
;              (cujos símbolos foram escolhidos de forma a promover a estética 
;              do jogo)
;--------------------------------------------------------------------------------
desenha_chao:   DEC     R6
                STOR    M[R6], R4
...
;--------------------------------------------------------------------------------
;escreveterreno: Esta função recebe como argumentos um vetor, a sua dimensão
;                e devolve a representação gráfica do terreno(incluindo o cato)
;                escrita no terminal.
;--------------------------------------------------------------------------------
...
;===============================================================================
;escrevedino: Esta função não recebe argumentos, e devolve a representação 
;             gráfica do dinossauro, na posição indicada pela variável 
;             CHAO_DINO
;===============================================================================
escrevedino:    DEC     R6 
                STOR    M[R6], R4
                ...
                JMP     R7
;===============================================================================
;saltodino: Esta função não recebe argumentos, e devolve o dinossauro na 
;           posição correspondente (dependendo se está a subir ou a descer)
;===============================================================================
saltodino:      DEC     R6 
                STOR    M[R6], R4
                DEC     R6
...
;================================================================================
;gameover: Esta função recebe o terreno do jogo como argumento e devolve a 
;          devolve a mensagem "GAME OVER" (reproduzida no terminal) se 
;          o jogador tiver perdido o jogo. Caso contrário, não é executada 
;          nenhuma operação
;================================================================================
...
;================================================================================
;PONTUACAO: Esta função recebe uma tabela (que contém a pontuação atual, em 
;           decimal) e devolve a incrementação da tabela em 1 valor (em decimal)
;================================================================================
PONTUACAO:      DEC     R6 
                STOR    M[R6], R4
                DEC     R6
...
; Quando as necessárias condições se verificarem, escreve-se o número no
; display LCD
.ESCREVE:                       
                MVI     R1, PONT
                LOAD    R2, M[R1]
